	...
	public List<Customer> getAllCustomers() {
		...
		try {
            ...
            for (int row = 0; row < numRows; row++) {
            	...
            	aCustomer.setCusNo(result.getString("CustomerNumber"));
            	aCustomer.setCusName(result.getString("Name"));
            	aCustomer.setCusAddress(result.getString("Address"));
            	aCustomer.setCusCity(result.getString("City"));
            	aCustomer.setCusState(result.getString("State"));
            	aCustomer.setCusZip(result.getString("Zip"));
