...
public class InClassExerciseDemo {
	...
	public static void main(String[] args) throws ParseException {
		...
		InClassExercise exercise = new InClassExercise(title, dueDate);
		...
		System.out.println("The exercise is due on " + exercise.getDueDate());
		System.out.println("The score for the exercise is: " + exercise.getScore());
