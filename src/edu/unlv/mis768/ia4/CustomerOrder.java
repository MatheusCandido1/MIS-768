...
public class CustomerOrder {
	// fields
	private boolean oilChange;	// Whether this task is performed
	private boolean lubeJob;
	private boolean radiatorFlush;
	private boolean transmissionFlush;
	private boolean inspection;
	private boolean mufflerReplacement;
	private boolean tireRotation;
	
	private double partPrice;	// cost for the parts
	private double laborPrice;	// cost for the labor
	...
	public double getTotal(){
		...
		subTotal = (subTotal + this.partPrice+this.laborPrice)*(1-this.discount);
