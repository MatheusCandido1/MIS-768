...
public class CreditCardApproval {
	...
	/**
	 * The moethod determines whether it is qualified
	 * @param amount The salary
	 * @param rating THe credit rating
	 * @return True or False for qualification
	 */
	private static boolean determineQualification(double amount, int rating) {
		return (amount >= 20000 && rating >= 7);
	}
